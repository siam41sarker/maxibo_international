    ...
    return (
        <section className="w-full bg-[#F9FAFB] py-24 px-6">
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.15)] border border-gray-200 p-10 md:p-14 text-center">
                ...
                {/* Description */}
                <p className="font-inter text-gray-500 text-base md:text-lg mb-10 max-w-2xl mx-auto leading-relaxed">Contact us to learn more about the equipment from our world-class partners and how they can benefit your business.</p>
                {/* Buttons */}
...
export default InterestedInProducts